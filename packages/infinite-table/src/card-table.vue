...
export default {
  ...
  methods: {
    ...
    openCMore (children) {
      ...
      const riskDetailContainerEl = document.querySelector('.riskDetail-container-content')
      if (riskDetailContainerEl) {
        localStorage.setItem('scrollTop', riskDetailContainerEl.scrollTop)
      }
      this.$router.push({
